...
public class ScarpFloor : UIWidget
{
...
//
        ...
        {
            //스프라이트 이름을 가져 옴.            
            if (ManagerScarp.instance._arrayTile[i]._sprite_name == "NonScarp")
                mSprite = atlas.GetSprite("scarp_0-0");
            else
                mSprite = atlas.GetSprite(ManagerScarp.instance._arrayTile[i]._sprite_name);
