...
[ExecuteInEditMode]
public class EnvironmentSprite : UIWidget
{
    ...
    public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
        ...
        switch (type)
        {
            ...
            case Type.CustomBlockTile:
                CustomBlockTileFill(verts, uvs, cols);
                break;

            case Type.CustomGroundFill:
                CustomGroundFill(verts, uvs, cols);
                break;

            case Type.CustomCloud:
                CustomCloud(verts, uvs, cols);
                break;
        }
    }
    ...
    protected void CustomCloud(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
        ...
        verts.Add(new Vector3(v.x + scale * 2, v.y));
        verts.Add(new Vector3(v.x + scale * 2, v.w + scale * 2));   //
        verts.Add(new Vector3(v.z, v.w + scale * 2));   //
        verts.Add(new Vector3(v.z, v.y));

        //uvs.Add(uv0);

        uvs.Add(new Vector2(uv0.x, uv0.y));
    ...
    protected void BlockFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
        ...
        {
            Vector2 uv0 = new Vector2(mOuterUV.xMin, mOuterUV.yMin);
            Vector2 uv1 = new Vector2(mOuterUV.xMax, mOuterUV.yMax - (mOuterUV.yMax - mOuterUV.yMin) * blockRatio);//(mOuterUV.yMax - mOuterUV.yMin) * ratio);
        ...
        {
            Vector2 uv0 = new Vector2(mOuterUV.xMin, mOuterUV.yMin - (mOuterUV.yMin - mOuterUV.yMax) * (1f + blockRatio));
            Vector2 uv1 = new Vector2(mOuterUV.xMax, mOuterUV.yMax);
        ...
        /*      else
              {
                  Vector2 uv0 = new Vector2(mOuterUV.xMin, mOuterUV.yMin);
                  Vector2 uv1 = new Vector2(mOuterUV.xMax, mOuterUV.yMax - (mOuterUV.yMax - mOuterUV.yMin) * (1f + blockRatio));

                  verts.Add(new Vector3(1f, -blockRatio - 1f, 0f));
                  verts.Add(new Vector3(1f, -1f, 0f));
                  verts.Add(new Vector3(0f, -1f, 0f));
                  verts.Add(new Vector3(0f, -blockRatio - 1f, 0f));
    ...
    protected void SimpleFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
    ...
    public float _scale = 3f;
    [System.NonSerialized]
    public float _scaleSpeed = 3f;
    float scale = 0f;

    void Update()
    {
        //좌, 우 움직임.
        if(type == Type.CustomGroundFill)
            scale = 1f + Mathf.Sin(Time.time * _scaleSpeed + cachedTransform.localPosition.x * 0.1f) * _scale;
    }

    protected void CustomGroundFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
        Vector2 uv0 = new Vector2(mOuterUV.xMin, mOuterUV.yMin);
        Vector2 uv1 = new Vector2(mOuterUV.xMax, mOuterUV.yMax);
        ...
        verts.Add(new Vector3(v.x, v.y));
        verts.Add(new Vector3(v.x + scale, v.w));   //
        verts.Add(new Vector3(v.z + scale, v.w));   //
        verts.Add(new Vector3(v.z, v.y));
    ...
    protected void CustomBlockTileFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
        Vector2 uv0 = new Vector2(mOuterUV.xMin, mOuterUV.yMin);
        Vector2 uv1 = new Vector2(mOuterUV.xMax, mOuterUV.yMax);
        ...
        uvs.Add(new Vector2(uv0.x + offset, uv0.y + offset));
        uvs.Add(new Vector2(uv0.x + offset, uv1.y - offset));
        uvs.Add(new Vector2(uv1.x - offset, uv1.y - offset));
        uvs.Add(new Vector2(uv1.x - offset, uv0.y + offset));
    ...
    protected void SlicedFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
    ...
    protected void TiledFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
    ...
    protected void FilledFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
    ...
    protected void AdvancedFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
        if (!mSprite.hasBorder)
        {
            SimpleFill(verts, uvs, cols);
    ...
    void FillBuffers(float v0x, float v1x, float v0y, float v1y, float u0x, float u1x, float u0y, float u1y, Color col,
        BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color> cols)
    {
